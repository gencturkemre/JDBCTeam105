...
public class JDBC02_execute_executeUpdate {
   ...
   C) - executeUpdate() metodu ise INSERT, Update gibi DML islemlerinde yaygin kullanilir.
      ...
      - Ayrıca, DDL islemlerinde de kullanilabilir ve bu islemlerde 0 dondurur.
        ...
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sys?serverTimezone=UTC", "root", "e.616161");
        Statement st = con.createStatement();

     /*======================================================================
          ORNEK1:isciler tablosunu siliniz  ---burayı yoruma aldım sebep tekrar silmesin
    ========================================================================*/
       ...
       /* String dropTable = "DROP TABLE isciler";
        ...
        } else System.out.println("isciler tablosu silme işlemi gerçekleşmedi");
*/
 ...
 /*=======================================================================
	...
	========================================================================*/
        ...
        if (!st.execute(createTable)) {
            System.out.println("isciler tablosu createTable edildi");
        } else System.out.println("isciler tablosu createTable işlemi gerçekleşmedi");
        ...
        System.out.println("işlemden etkilenen satir sayisi : " + satirSayisi);
 ...
 /*=======================================================================
        ...
        System.out.println("==============01.yol============");

        String[] sorgular = {"INSERT INTO isciler VALUES(70, 'HR', 5000)", "INSERT INTO isciler VALUES(60, 'LAB', 3000)",
                "INSERT INTO isciler VALUES(50, 'ARGE', 4000)"};
